...
interface UploadTerminalKeysDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess?: () => void;
}

export function UploadTerminalKeysDialog({
  open,
  onOpenChange,
  onSuccess,
}: UploadTerminalKeysDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Upload Terminal Keys</DialogTitle>
          <DialogDescription>
            Drag and drop your Excel file here or click to browse. File must
            contain terminal credentials for bulk import.
          </DialogDescription>
        </DialogHeader>
        <div
